...
public class TrackYourOrderPage {
	...
	public void trackOrderWithoutSignIn(String OrderId, String sEmailID)
	{
		//Order Number
		uiTrackYourOrderPg_OrderTb.clear();
		uiTrackYourOrderPg_OrderTb.sendKeys(OrderId);
		
		//Email ID
		uiTrackYourOrderPg_EmailIdTb.clear();
		uiTrackYourOrderPg_EmailIdTb.sendKeys(sEmailID);
